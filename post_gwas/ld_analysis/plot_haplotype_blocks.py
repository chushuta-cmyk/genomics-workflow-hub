...
def main():
    ...
    plt.title('Haplotype Block Size Distribution', fontsize=14)
    plt.grid(True, linestyle='--', alpha=0.5)
    plt.tight_layout()
    plt.savefig('results/wild/ld_analysis/haplotype_block_size_distribution.png', dpi=300)
    ...
    plt.title('Haplotype Block Count per Chromosome', fontsize=14)
    ...
    plt.tight_layout()
    plt.savefig('results/wild/ld_analysis/haplotype_block_count_per_chr.png', dpi=300)
