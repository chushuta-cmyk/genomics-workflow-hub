...
# Paths
wild_dir = "results/wild/post_gwas"
cult_dir = "results/cultivated/post_gwas"
...
def main():
    ...
    wild_ld = os.path.join("results/wild/ld_analysis", "ld_decay_summary.tsv")
    cult_ld = os.path.join("results/cultivated/ld_analysis", "ld_decay_summary.tsv")
