...
def main():
    ...
    # Define traits and corresponding files for cultivated data
    traits = [
        {
            "name": "100SW",
            "file": "data/input/workflow/output/size_analysis.assoc.txt",
            "output": f"{output_dir}/cultivated_manhattan_100SW.png"
        },
        {
            "name": "Protein",
            "file": "data/input/workflow/output/protein_analysis.assoc.txt",
            "output": f"{output_dir}/cultivated_manhattan_Protein.png"
        },
        {
            "name": "Oil",
            "file": "data/input/workflow/output/oil_analysis.assoc.txt",
            "output": f"{output_dir}/cultivated_manhattan_Oil.png"
        },
        {
            "name": "Oil_Protein_Ratio",
            "file": "data/input/workflow/output/ratio_gwas.assoc.txt",
            "output": f"{output_dir}/cultivated_manhattan_Ratio.png"
        }
    ]
