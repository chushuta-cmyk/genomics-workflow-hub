...
def main():
    summary_file = "results/cultivated/ld_analysis/ld_decay_summary.tsv"
    plot_file = "results/cultivated/ld_analysis/cultivated_ld_decay_curve.png"
    ...
    plt.title('LD Decay Curve (Cultivated Soybean)', fontsize=14)
